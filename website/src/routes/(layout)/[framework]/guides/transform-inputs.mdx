...
> Input transformation works only if your fields are controlled. Make sure you have read the guide to <A href="../controlled-fields">controlled fields</A> beforehand.
...
As with the `validate` property, you can pass a single function or multiple functions in an array. You can use our <Solid><A href="../../api/toCustom">`toCustom`</A></Solid><Qwik><A href="../../api/toCustom$">`toCustom$`</A></Qwik> function or write your own functions based on it. More on that in a moment.
...
The first parameter of the <Solid><A href="../../api/toCustom">`toCustom`</A></Solid><Qwik><A href="../../api/toCustom$">`toCustom$`</A></Qwik> function is executed if the current event type is the event type you specified in the second parameter. The function gives you access to the current `value`, as well as to the `event` object<Solid>, which you can use to access the reference of the `<input />` element via `event.currentTarget` if needed</Solid><Qwik> and `element` reference</Qwik>.

## Create custom functions

To make your code reusable and more readable, you can create your own transformation functions based on <Solid><A href="../../api/toCustom">`toCustom`</A></Solid><Qwik><A href="../../api/toCustom$">`toCustom$`</A></Qwik>. As promised, we show how this works, using a phone number transformation as an example.
