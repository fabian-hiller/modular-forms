...
> We do not rule out adding optional support for Jup and Zod in the future. If you are interested, please create an <a href="https://github.com/fabian-hiller/modular-forms/issues/new" target="_blank" rel="noreferrer">issue</a> on GitHub.
