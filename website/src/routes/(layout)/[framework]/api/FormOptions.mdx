...
- `FormOptions` <Property {...properties.FormOptions} />
  ...
  - `fieldArrays` <Property {...properties.qwik.fieldArrays} />
...
If your form contains field arrays, you must specify their paths in `fieldArrays` so that the stores of the field arrays can be initialized properly.
