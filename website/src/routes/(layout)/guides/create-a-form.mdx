...
The tuple allows you to freely name the individual return values. This can be useful, for example, if a single page contains multiple forms. The returned <A href="/api/Form">`Form`</A>, <A href="/api/Field">`Field`</A> and <A href="/api/FieldArray">`FieldArray`</A> component are already connected with the store of your form. Also, if you are using TypeScript, they are aware of your fields and their data types, which gives you the benefit of type safety and autocompletion.
