...
- `options` <Property {...properties.options} />
  - `initialValues` <Property {...properties[isQwik() ? 'qwik' : 'solidPreactOrReact'].initialValues} />
...
When you reset the entire form or several fields, you can specify new `initialValues` that override the <SolidPreactOrReact>`initialValues`</SolidPreactOrReact><Qwik>`loader`</Qwik> you <SolidPreactOrReact>may</SolidPreactOrReact> specified in the <Solid><A href="../createForm">`createForm`</A> primitive</Solid><QwikPreactOrReact><A href="../useForm">`useForm`</A> hook</QwikPreactOrReact>.

When you reset a single field, you can specify a new `initialValue` that override the initial value you <SolidPreactOrReact>may</SolidPreactOrReact> set in the <SolidPreactOrReact>`initialValues`</SolidPreactOrReact><Qwik>`loader`</Qwik> of the <Solid><A href="../createForm">`createForm`</A> primitive</Solid><QwikPreactOrReact><A href="../useForm">`useForm`</A> hook</QwikPreactOrReact>.
