...
> The `useFieldArray` primitive is used internally in the [`FieldArray`](fieldarray) component. It's better to use the [`FieldArray`](fieldarray) component and only if there is a good reason to switch to the `useFieldArray` primitive.
