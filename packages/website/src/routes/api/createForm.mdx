...
export const properties = {
  Values: {
    type: { type: 'custom', name: 'ModularValues', href: '/api/ModularValues' },
  },
  options: {
    type: 'object',
  ...
  initialValues: {
    type: {
      ...
      name: 'DeepPartial',
      generics: [
        { type: 'custom', name: 'ModularValues', href: '/api/ModularValues' },
      ],
    },
    defaultValue: { type: 'object', entries: [] },
  },
  ...
  form: {
    type: { type: 'custom', name: 'ModularForm', href: '/api/ModularForm' },
  },
};
