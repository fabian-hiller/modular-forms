...
Modular Forms consists of <Solid>primitives</Solid><QwikOrPreact>hooks</QwikOrPreact>, components and methods. To create a form you use the <Solid><A href="../../api/createForm">`createForm`</A> primitive</Solid><QwikOrPreact><A href="../../api/useForm">`useForm`</A> hook</QwikOrPreact>.
