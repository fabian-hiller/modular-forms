...
import { Description, Qwik, SolidPreactOrReact, Title } from '~/components';
...
If you prefer to infer your type definition from a schema, you can optionally use <a href="https://github.com/fabian-hiller/valibot" target="_blank" rel="noreferrer">Valibot</a> or <a href="https://github.com/colinhacks/zod" target="_blank" rel="noreferrer">Zod</a> for that. Below is an example with Valibot:
...
type SpecialForm = InferInput<typeof SpecialSchema>;
```
