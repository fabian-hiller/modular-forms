...
You can validate almost anything with one line of code. Also you have the possibility to set your own error message and access the current error via the render function of the [`Field`](/api/field) component. An overview of all validation functions can be found in our [API references](/api).
