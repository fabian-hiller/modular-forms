...
<Description>
  ...
  FieldArray component in a tuple.
</Description>
...
Creates and returns the store of the form as well as a linked Form, Field and FieldArray component in a tuple.

```ts
const [form, Form, Field, FieldArray] = useForm<Values>(options);
```
