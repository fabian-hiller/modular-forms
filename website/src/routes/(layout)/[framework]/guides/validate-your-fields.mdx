...
Use <A href="../../api/valiForm">`valiForm`</A> to define the validation for the whole form and <A href="../../api/valiField">`valiField`</A> for a single field. Below is the same login form as in the example above. Instead of our validation functions, Valibot is used now.
